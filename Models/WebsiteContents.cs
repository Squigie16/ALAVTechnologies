...
namespace LloydStephanieRealty.Models
{
    public class WebsiteContents
    {
        ...
        public string AboutUsLloyd { get; set; } = "ufhjdbjdbjfhd hsdjhf dsfh sdhfhdjsbfjdhfjfh dshfjsd fhdsjhdfj dhf jsd dhsofhdjdfsh jdfsh dfdfsjsdfh f";
        public string AboutUsStephanie { get; set; } = "ufhjdbjdbjfhd hsdjhf dsfh sdhfhdjsbfjdhfjfh dshfjsd fhdsjhdfj dhf jsd dhsofhdjdfsh jdfsh dfdfsjsdfh f";
        public string CompanyPhoneNumber { get; set; } = "123-456-7890";
        public string CompanyEmailAddress { get; set; } = "placeholder@mail.com";
        public string CompanyHeadquarters { get; set; } = "123 Main St, Oakville Ontario";
        public string InitialSignUpEmail { get; set; }
        public string HomePageHeader { get; set; }
        public string HomePageParagraph { get; set; }
        public string HomePageTalkToUsText { get; set; } = "Reach out to us to find out if we are your perfect fit!";
        public string HomePageMeetUsText { get; set; } = "Get to know us and why we would be a perfect fit for you!";
